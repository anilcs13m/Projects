...
# which contains 25,000 IMDB movie reviews, each with a       #
# positive or negative sentiment label.                       #
###############################################################
...
###############################################################
# Here, "header=0" indicates that the first line of the file  #
# contains column names, "delimiter=\t" indicates that the    #
# fields are separated by tabs, and quoting=3 tells Python to #
# ignore doubled quotes, otherwise you may encounter errors   #
...
################################################################
# Second file "testData.tsv" This file contains another 25,000 #
# reviews and ids; Our task is to predict the sentiment label. #
# Import the pandas package, then use the "read_csv" function  #
...
def review_to_wordlist( review, remove_stopwords=False ):
    ...
    # optionally removing stop words.  Returns a list of        #
    # words.                                                    #
