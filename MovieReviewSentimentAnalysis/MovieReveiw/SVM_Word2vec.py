...
# our task is to predict the sentiment labelself.                               #
#################################################################################                    
...
# tells Python to ignore doubled quotes, otherwise you may encounter errors trying #
# to read the fileself.                                                            #
####################################################################################
...
rf_p = svc.predict_proba(testDataVecs)
